export default function HiddenSectionFour({ isVisible }) {
  return (
    <div
      className={`hidden-section radius0 noBorder c-section c-wrapper section-IYYEZ9TFTW  ${
        isVisible ? "shown" : ""
      }`}
      style={{}}
          ...
          <div className="inner">
            ...
            >
              <div className="vertical inner">
                ...
                <div id="heading-Djp-qiQQSU" className="c-heading c-wrapper">
                  <div
                  ...
                  >
                    <div>
                      <h1>
                        ...
                        <strong>INSTANT</strong> ACCESS. <strong>ZERO</strong>{" "}
                        RISK
                      </h1>
                    </div>
                  </div>
            ...
            >
              <div className="vertical inner">
                ...
                >
                  ...
                  >
                    <div>{/* <p>The wealth path you will build</p> */}</div>
                  </div>
                </div>
              </div>
            </div>
